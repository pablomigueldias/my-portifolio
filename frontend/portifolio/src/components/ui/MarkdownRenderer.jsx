...
const MarkdownRenderer = ({ content }) => {
    ...
    const components = {
        ...
        p: ({ ...props }) => <p className="mb-6 leading-relaxed text-base md:text-lg text-muted-foreground break-words text-justify" {...props} />,
        ...
        a: ({ ...props }) => <a className="text-primary hover:text-primary/80 underline underline-offset-4 decoration-primary/30 break-all" {...props} />,
